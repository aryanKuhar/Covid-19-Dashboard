...
-- PARSING COVID DATA BY DEATHS, CASES, VACCINATIONS, COUNTRIES, POPULATION, Etc.
...
OVER (Partition by dea.location), dea.date) as RollingPeopleVaccinated --, (RollingPeopleVaccinated/population)*100
...
-- Create a chart for Percentage of Population Vaccinated
